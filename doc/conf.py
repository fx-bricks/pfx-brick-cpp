...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'sphinx.ext.autosummary', 'breathe']

breathe_projects = {
    "pfxbrick": "doxygen/build/xml/"
}

breathe_default_project = 'pfxbrick'
...
html_title = "PFx Brick C++ API Documentation"
...
latex_documents = [
  ('index', 'PFxBrick.tex', 'PFx Brick C++ API Documentation',
   'Fx Bricks', 'manual'),
]
...
man_pages = [
    ('index', 'pfxbrick', 'PFx Brick C++ API Documentation',
     ['Fx Bricks'], 1)
]
...
texinfo_documents = [
  ('index', 'PFxBrick', 'PFx Brick C++ API Documentation',
   'Fx Bricks', 'PFxBrick', 'PFx Brick C++ access API',
   'Miscellaneous'),
]
